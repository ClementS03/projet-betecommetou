...
define( 'DB_USER', 'first_wp' );

/** Mot de passe de la base de données MySQL. */
define( 'DB_PASSWORD', 'first_wp' );
 ...
 * @since 2.6.0
 */
define( 'AUTH_KEY',         'XT.&]t896H@G>Q6LD6nE(uXFnKNl*R^U+{L0X5MwB%[RIWjuhq8!?V6xwfkJlU-9' );
define( 'SECURE_AUTH_KEY',  '6V-Rv8;[b%Zsq|])4W.+KK%`}>%*s<XsN2Rz/XVNuhJm>X~4Xq)d;9o+N +={emi' );
define( 'LOGGED_IN_KEY',    'Ji4Yj>R+UyWRfJ65aMDVqhcQ~~-`Oz&d}Pn|Akb>Q^(nRfS>t0)+TaS5nU)lYY6.' );
define( 'NONCE_KEY',        '5K(#Ry&=F,0=y_F@;ZyvinA]w7$n2#WO>6/M wLWa6HJc8 v$-| `2VF=h;^uyZH' );
define( 'AUTH_SALT',        '&azV?HHcglzcdG#*!vz~DhSwbZ=a|&MzkI6GFllsPi<)%FeE/WsF%XIKfEwjBj5E' );
define( 'SECURE_AUTH_SALT', '3X39zD`$6_hz]mphhoK-dZ^uzX{+I9RM7%LGGvpl1ft%>)]%tNV&4XWL?g1&R]}}' );
define( 'LOGGED_IN_SALT',   'a>_`Q]va{MYNVm{_T~wO0}N!0lU0tX}%Q#F7KbNa%7JP)7Ztm klZ&.rT7V{mF8M' );
define( 'NONCE_SALT',       ',Y8yV5!LI<+cjcb=S-{JeHtv)kf_mQ}dho]LVu8XfkM/@VR~oJbz]vv@C 3PMbNN' );
/**#@-*/
